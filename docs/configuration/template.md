...
```json
{
  ...
  "disable_clash_dashboard": false,
  "download_clash_dashboard": false,
  "clash_mode_rule": "",
  "clash_mode_global": "",
  "clash_mode_direct": "",
...
Use default outbound to download rule sets or Geo resources, instead of use jsDelivr CDN and direct downlaod.
...
#### disable_clash_dashboard

Don't generate `clash_api.external_controller`.

#### download_clash_dashboard

Generate `clash_api.external_ui`.
