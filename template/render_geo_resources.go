...
func (t *Template) renderGeoResources(metadata M.Metadata, options *option.Options) {
	if t.DisableRuleSet || (metadata.Version == nil || metadata.Version.LessThan(semver.ParseVersion("1.8.0-alpha.10"))) {
		...
		if t.DisableJSDelivr {
			geoipDownloadURL = "https://github.com/SagerNet/sing-geoip/releases/download/latest/geoip-cn.db"
			geositeDownloadURL = "https://github.com/SagerNet/sing-geosite/releases/download/latest/geosite-cn.db"
		} else {
