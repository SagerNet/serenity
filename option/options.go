...
type OutboundProcessOptions struct {
	...
	Rename      *badjson.TypedMap[string] `json:"rename,omitempty"`
...
type Profile struct {
	...
	TemplateForPlatform  *badjson.TypedMap[string] `json:"template_for_platform,omitempty"`
	TemplateForUserAgent *badjson.TypedMap[string] `json:"template_for_user_agent,omitempty"`
